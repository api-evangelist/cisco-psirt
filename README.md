...
Cisco publishes a fetchable first-party specification for this API. Harvested into openapi/_original/ with an x-provenance stamp.

## Verified links

- [Portal](https://developer.cisco.com/psirt/)
- [Documentation](https://developer.cisco.com/docs/psirt/)
- [APIReference](https://developer.cisco.com/psirt/)
- [ParentCompany](https://apis.io/providers/cisco/)
- [OpenAPI Source](https://github.com/CiscoPSIRT/openVulnAPI)
- [GitHubOrganization](https://github.com/CiscoPSIRT)
